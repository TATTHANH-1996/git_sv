...
enum QoS { QOS0, QOS1, QOS2, SUBFAIL=0x80 }; // Ở ĐÂY QOS0 ĐƯỢC GÁN =0 VÀ CÁC BIẾN SAU TĂNG DẦN

/* all failure return codes must be negative */
enum returnCode { BUFFER_OVERFLOW = -2, FAILURE = -1, SUCCESS = 0 };// KIỂU ENUM CHÍNH LÀ LIỆT KÊ
...
extern void TimerInit(Timer*); //DÙNG ĐỂ KHAI BÁO CÁC “external variable” ĐỂ CHIA SẺ CHÚNG VỚI CÁC SOURCE FILES
